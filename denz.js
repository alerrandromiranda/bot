...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:TONY\n'
            + 'ORG:Owner TONY 𝙱𝙾𝚃;\n'
            + 'TEL;type=CELL;type=VOICE;waid=554398434473:+55 43 98434473\n'
            + 'END:VCARD'
       
const vcard1 = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + 'FN:Otávio\n'
            + 'ORG:Co Owner Otávio 𝙱𝙾𝚃;\n'
            + 'TEL;type=CELL;type=VOICE;waid=5511957505042:+55 11 95750 5042\n'
            + 'END:VCARD'
      
   const vcard2 = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + 'FN:Biel shark\n'
            + 'ORG:Co2 Owner Biel 𝙱𝙾𝚃;\n'
            + 'TEL;type=CELL;type=VOICE;waid=553288716525:+55 32 8871 6525\n'
            + 'END:VCARD'   

prefix = "."
name = "BOT DO TONY"
rdaftar = "OBRIGADO POR SE REGISTAR PARA SER UM USUÁRIO DO TONY BOT😁"
rmenu = "Oi amigos do TONY "
botinfo = "SALVE"
limitt = 999999999
memberLimit = 2
ban = []
premium = ["554398434473@s.whatsapp.net","5511957505042@s.whatsapp.net","553288716525@s.whatsapp.net"]
...
async function starts() {
	...
	denz.on('connecting', () => {
		start('2', 'conectando com lorde screamo ❤️...')
	})
	denz.on('open', () => {
		success('2', 'ja esta conectado ❤️')
	})
...
ᴅɪɢɪᴛᴇ ${prefix}daftar ᴘᴀʀᴀ ᴄᴏᴍᴇᴄᴀʀ ᴀ ᴜsᴀʀ  ʙᴏᴛ`
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			const TONYBot = ["0@s.whatsapp.net"] // ubah aja gapapa
			...
			mess = {
				...
				success: '*sᴜᴄᴇssᴏ...*',
				error: {
					stick: '*Desculpe, ocorreu um erro ao converter a imagem ou gif em adesivo*',
					Iv: '*ᴍᴀᴀꜰ ʟɪɴᴋ ᴛɪᴅᴀᴋ ᴠᴀʟɪᴅ!*'
				},
				only: {
					group: '*𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙴, 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾 𝙿𝙾𝙳𝙴 𝚂𝙴𝚁 𝚄𝚂𝙰𝙳𝙾 𝙴𝙼 𝙶𝚁𝚄𝙿𝙾!*',
					benned: '*𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙴 𝚂𝙴𝚄 𝙽𝚄𝙼𝙴𝚁𝙾 𝙳𝙴 𝙿𝚁𝙾𝙸𝙱𝙸𝙳𝙾, 𝙿𝙾𝚁 𝙵𝙰𝚅𝙾𝚁, 𝙴𝙽𝚃𝚁𝙴 𝙴𝙼 𝙲𝙾𝙽𝚃𝙰𝚃𝙾 𝙲𝙾𝙼 𝙾 𝙿𝚁𝙾𝙿𝚁𝙸𝙴𝚃𝙰𝚁𝙸𝙾 𝙿𝙰𝚁𝙰 𝙰𝙱𝚁𝙸𝚁 𝚂𝙴𝚄 𝙿𝚁𝙾𝙸𝙱𝙸𝙳𝙾*',
					ownerG: '*𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙰 𝙲𝙼𝙰𝙽𝙳𝙾 𝚂𝙾 𝙿𝙾𝙳𝙴 𝚂𝙴𝚁 𝚄𝚂𝙰𝙳𝙾 𝙿𝙴𝙻𝙾𝚂 𝙰𝙳𝙼 𝙴𝙼 𝙶𝚁𝚄𝙿𝙾𝚂 !*',
					ownerB: '*𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙰 𝙲𝙼𝙰𝙽𝙳𝙾 𝚂𝙾 𝙿𝙾𝙳𝙴 𝚂𝙴𝚁 𝚄𝚂𝙰𝙳𝙾 𝙿𝙴𝙻𝙾 𝙳𝙾𝙽𝙾 𝙳𝙾 𝙱𝙾𝚃!* ',
					premium: '*𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙰 𝚁𝙴𝙲𝚄𝚁𝚂𝙾 𝚂𝙾 𝙿𝚁𝙰 𝚄𝚂𝚄𝙰𝚁𝙸𝙾 𝙿𝚁𝙴𝙼𝙸𝚄𝙼!*',
					userB: `𝙾𝙻𝙰  *${pushname2}*, 𝚅𝙾𝙲𝙴 𝙽𝙰𝙾 𝙴𝚂𝚃𝙰 𝚁𝙴𝙶𝙸𝚂𝚃𝚁𝙰𝙳𝙾 𝙽𝙾 𝙱𝙰𝙽𝙲𝙾 𝙳𝙴 𝙳𝙰𝙳𝙾𝚂, 𝙳𝙸𝙶𝙸𝚃𝙴 \n*${prefix}daftar*`,
					admin: '*𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙰 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙿𝙾𝙳𝙴 𝚂𝙴𝚁 𝚄𝚂𝙰𝙳𝙾 𝚂𝙾 𝙿𝙴𝙻𝙾𝚂 𝙰𝙳𝙼 𝙳𝙾 𝙶𝚁𝚄𝙿𝙾!*',
					Badmin: '*𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙴, 𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝚂𝙾 𝙿𝙾𝙳𝙴 𝚂𝙴𝚁 𝚄𝚂𝙰𝙳𝙾 𝚀𝚄𝙰𝙽𝙳𝙾 𝙾 𝙱𝙾𝚃 𝚅𝙸𝚁𝙰 𝙰𝙳𝙼!*',
					publikG: `𝙳𝙴𝚂𝙲𝚄𝙻𝙿𝙴, 𝙾 𝙱𝙾𝚃 𝙰𝙶𝙾𝚁𝙰 𝙴 𝙿𝚁𝙸𝚅𝙰𝙳𝙾 𝙿𝙴𝙻𝙾 𝙳𝙾𝙽𝙾\n𝙿𝙰𝚁𝙰 𝚂𝙰𝙱𝙴𝚁 𝙼𝙰𝙸𝚂 𝙳𝙸𝙶𝙸𝚃𝙴  \n*${prefix}infobot*`
				}
			}

			const botNumber = denz.user.jid
			const ownerNumber = ["554398434473@s.whatsapp.net","5511957505042@s.whatsapp.net","553288716525@s.whatsapp.net"] // numero dos donos
...
ʜᴇɪ *${pushname2}* ᴘᴏʀғᴀᴠᴏʀ ᴅɪɢɪᴛᴇ *${prefix}menu*
        ────────────────`
denz.sendMessage(from, hasil, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "ketik #menu kak", 'jpegThumbnail': fs.readFileSync('./sticker/TONYnew.webp')}}}})
}
		if (bad.includes(messagesLink)) {
		if (!isGroup) return
		...
		setTimeout( () => {
		reply(`*_「 𝑃𝑎𝑙𝑎𝑣𝑟𝑎 𝑜𝑓𝑒𝑛𝑠𝑖𝑣𝑎 𝐷𝑒𝑡𝑒𝑐𝑡𝑎𝑑𝑎」_*\n𝐷𝑒𝑠𝑐𝑢𝑙𝑝𝑒 *${pushname2}* VOCÊ ESTÁ XINGANDO NO GRUPO E SERÁ REMOVIDO! *${groupMetadata.subject}*`)
		}, 0)
		}
				...
				case 's':
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								...
								denz.sendMessage(from, buff, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "nih ajg", 'jpegThumbnail': fs.readFileSync('./sticker/TONYnew.webp')}}}})
								fs.unlinkSync(media)
								fs.unlinkSync(ran)
							})
...
case 'igpost': 				
		...
		case 'fakeaddress': 
				...
				buffer = await getBuffer(anu.result.url)
				denz.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "@denssptraa", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('TONYnew.jpg')} } }, caption: 'Nih hasilnya kak...'})
				break 
				case 'hbd': 				
				if (args.length < 1) return reply(`textnya mana om?`)	
				ct = body.slice(4)
		...
		case 'bacaansholat': // Case By Arga
				...
				denz.sendMessage(from, buffer7, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "@denssptraa", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('TONYnew.jpg')} } }, caption: teks})
				break
		case 'tahlil': 
				reply(`[❕] Loading`)
		...
		case 'dkasia': // Update By RzkyO 7 ItsmeikyXSec404
				...
				denz.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "@denssptraa", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('TONYnew.jpg')} } }, caption: hasil})
				break
		...
		case 'cekresijne': 
				...
				denz.sendMessage(from, hasil, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "@denssptraa", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('TONYnew.jpg')} } }, caption: 'ini hasilnya kak'})
				teks = '=================\n'
				...
				buffer = await getBuffer(anu.result.url)
				denz.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "@denssptraa", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('TONYnew.jpg')} } }, caption: 'ini fotonya kak'})
				break
		case 'blackpink': 
				reply(`[❕] Loading`)
  ...
  break
			...
			if (!isUser) return reply(mess.only.userB)
				...
				case 'info':
					...
					teks = `➽ *𝑁𝑜𝑚𝑒 ʙᴏᴛ* : ${me.name}\n➽ *ᴅᴏɴᴏ ʙᴏᴛ* : TioCafe\n➽ *ᴘʀᴇғɪx* : | ${prefix} |\n➽ *ᴛᴏᴛᴀʟ ʙʟᴏǫᴜᴇᴀᴅᴏ* : ${blocked.length}\n➽ *ᴀᴛɪᴠᴏ ᴅᴇsᴅᴇ* : ${kyun(uptime)}\n➽ *ᴛᴏᴛᴀʟ ᴜʟᴛɪʟɪᴢᴀɴᴅᴏ* : ${user.length} ᴜsᴜᴀʀɪᴏ\n➽ *ɪɴꜱᴛᴀɢʀᴀᴍ* : https://www.instagram.com/lordescreamocanal/\n➽ *ɢʀᴜᴘᴏ* : https://chat.whatsapp.com/EgRRS1B2bWp3xKVGYakxF5\n➽ *ᴘᴀʀᴄᴇʀɪᴀs* :\n➽ ᴍᴀғɪᴀ ᴅᴏs ᴛᴜᴛᴏʀs\n➽ ᴄᴏᴘɪᴀᴅᴏʀ ᴜᴄʜɪʜᴀ\n➽ ᴍᴏsᴄᴀ ᴠɪʀᴜs\n➽ ᴍᴜɴᴅᴏ ᴄɪʙᴇʀɴᴇᴛɪᴄᴏ\n➽ ᴄᴏʀᴛᴇs TONY\n➽ ᴘᴀɴᴛʜᴇʀs ᴛᴜᴛᴏʀs\n➽ ᴛʀᴜᴛʜᴇʀs ᴄʜᴀᴛ ᴀᴘᴋs`
					const daca = fs.readFileSync('TONYnew.jpg');
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}tahta TONY`)
tekts = body.slice(7)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}burnpaper TONY`)
todi = body.slice(11)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}8bit TONY/bot`)
ds = `${body.slice(6)}`
tex1 = ds.split("/")[0];
tex2 = ds.split("/")[1];
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}glowneon TONY`)
tekas = body.slice(10)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}gsuggest TONY/bot/wea`)
du = `${body.slice(10)}`
ted1 = du.split("/")[0];
ted2 = du.split("/")[1];
ted3 = du.split("/")[2];
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}candlemug TONY`)
ddu = body.slice(11)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}lovemss TONY`)
lop = body.slice(9)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}mugflower TONY`)
mug = body.slice(11)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}narutobanner TONY`)
nar = body.slice(14)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}paperglass TONY`)
papg = body.slice(12)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}romance TONY`)
roce = body.slice(9)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}shadow TONY`)
sdow = body.slice(8)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}glitch TONY/bot`)
gl = `${body.slice(8)}`
gel1 = gl.split("/")[0];
gel2 = gl.split("/")[1];
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}coffe TONY`)
kop = body.slice(7)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}candy TONY`)
cndy = body.slice(7)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}hpotter TONY`)
hpter = body.slice(9)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}woodblock TONY`)
woblk = body.slice(11)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}galaxtext TONY`)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}pupycute TONY`)
puki = body.slice(10)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}galaxstyle TONY`)
gelay = body.slice(12)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}hologram TONY`)
gram = body.slice(10)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}metallogo TONY`)
metal = body.slice(11)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}bpink TONY`)
black = body.slice(7)
reply(mess.wait)
       ...
       exec(`wget ${anu1} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
            ...
            break  
				...
				case 'dono':
                 ...
                 denz.sendMessage(from, '*_ᴅᴜᴠɪᴅᴀs sᴏʙʀᴇ ᴏ ʙᴏᴛ sᴀʟᴠᴇ ᴏ ɴᴜᴍᴇʀᴏ  :)_*',text, { quoted: mek} )
                 break
                 case 'coowner':
...
quoted: mek, caption: `Hasil Dari *${daerah}*`
  ...
  break
			    ...
			    if (!isUser) return reply(mess.only.userB)
					...
					mentions(`╔═══✪ Marcar Os Boi Do Grupo *${pushname2}* ✪══`+ teks +'╚═══〘 *TONYBOT* 〙═══', members_id, true)
					break
			    case 'mentionall':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
					...
					mentions(`╔══〘  *${body.slice(12)}*  〙✪══`+teks+'╚═〘 *TONY BOT* 〙', members_id, true)
					break
			    case 'kbbi':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
				...
				case 'clearall':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of groupMembers) {
							denz.sendMessage(_.jid, bcgc, image, {caption: `「 *_ᴛʀᴀɴsᴍɪᴛɪɴᴅᴏ ᴇᴍ ɢʀᴜᴘᴏ_* 」\n*ɢʀᴜᴘᴏ* : ${groupName}\n\n${body.slice(6)}`})
						}
						reply('')
					} else {
						for (let _ of groupMembers) {
							sendMess(_.jid, `「 *_ᴛʀᴀɴsᴍɪᴛɪɴᴅᴏ ᴇᴍ ɢʀᴜᴘᴏ_* 」\n*ɢʀᴜᴘᴏ* : ${groupName}\n\n${body.slice(6)}`)
						}
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							denz.sendMessage(_.jid, bc, image, {caption: `「 *_ᴛʀᴀɴsᴍɪᴛɪɴᴅᴏ_* 」\n\n${body.slice(4)}`})
						}
						denz.sendMessage(_.jid, bc, image, {caption: `「 *_ᴛʀᴀɴsᴍɪᴛɪɴᴅᴏ_* 」\n\n${body.slice(4)}`})
						reply('Transmissão de sucesso')
						} else {
						for (let _ of anu) {
							sendMess(_.jid, `「 *_ᴛʀᴀɴsᴍɪᴛɪɴᴅᴏ_* 」\n\n${body.slice(4)}`)
						}
						reply('Transmissão de sucesso')
					}
					break
			    ...
			    if (!isUser) return reply(mess.only.userB)
					...
					if (args.length < 1) return reply('Hmmmm')
					if ((args[0]) === 'on') {
						if (isNsfw) return reply('Mode nsfw está ativo ')
						nsfw.push(from)
...
case 'husbu':
			...
			break
				...
				if (budy.includes("://chat.whatsapp.com/")){
					...
					var kic = `${sender.split("@")[0]}@s.whatsapp.net`
						reply(`*_「 ʟɪɴᴋ ᴅᴇ ɢʀᴜᴘᴏ ᴅᴇᴛᴇᴄᴛᴀᴅᴏ 」_*\nᴅᴇsᴄᴜʟᴘᴇ *${pushname2}* ᴇsᴛᴇ ɢʀᴜᴘᴏ ɴᴀᴏ ᴘᴇʀᴍɪᴛᴇ ʟɪɴᴋs , sᴇᴜ ʙᴀɴ ᴇsᴛᴀ ᴄʜᴇɢᴀɴᴅᴏ *${groupMetadata.subject}*`)
						setTimeout( () => {
        ...
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : dj kukira dia menyukaiku", 'jpegThumbnail': fs.readFileSync('./sticker/TONYnew.webp')}}}})
        }
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : mamang garox remix", 'jpegThumbnail': fs.readFileSync('./sticker/TONYnew.webp')}}}})
        }
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : dj take away", 'jpegThumbnail': fs.readFileSync('./sticker/TONYnew.webp')}}}})
        }
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : dj tapi boong", 'jpegThumbnail': fs.readFileSync('./sticker/TONYnew.webp')}}}})
        }
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : dj into your arms", 'jpegThumbnail': fs.readFileSync('./sticker/TONYnew.webp')}}}})
        }
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : dj iri bilang boss", 'jpegThumbnail': fs.readFileSync('./sticker/TONYnew.webp')}}}})
        }
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : dj boma boma ye", 'jpegThumbnail': fs.readFileSync('./sticker/TONYnew.webp')}}}})
        }
        if (budy.includes("boma")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/boma.mp3')
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : dj new rules", 'jpegThumbnail': fs.readFileSync('./sticker/TONYnew.webp')}}}})
        }
        if (budy.includes("Rules")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/rules.mp3')
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "song : dj numa numa yei", 'jpegThumbnail': fs.readFileSync('./sticker/TONYnew.webp')}}}})
        }
        if (budy.includes("numa")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/numa.mp3')
        ...
        if (budy.includes("554398434473")){  // respon tag ubah aja
        reply(`ᴍᴀᴀғ *${pushname2}*, ᴏᴡɴᴇʀ ᴅɴꜱ ʙᴏᴛ ᴛɪᴅᴀᴋ ᴍᴇɴᴇʀɪᴍᴀ ᴛᴀɢ!`)
        const d = fs.readFileSync('./sticker/kanna.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "anak anjg", 'jpegThumbnail': fs.readFileSync('./sticker/TONYnew.webp')}}}})
        }
		...
		if (budy.includes(`Thanks`)) {
                  ...
                  if (budy.includes(`thanks`)) {
                  reply(`ꜱᴀᴍᴀ-ꜱᴀᴍᴀ ᴋᴀᴋ *${pushname2}*, TONY sᴀᴜᴅᴀᴅᴇs >-<`)
                  }
                  if (budy.includes(`makasih`)) {
                  reply(`ꜱᴀᴍᴀ-ꜱᴀᴍᴀ ᴋᴀᴋ *${pushname2}*, TONY sᴀᴜᴅᴀᴅᴇs >-<`)
                  }
                  ...
                  if (budy.includes(`TONY`)) {
                  reply(`ᴏʟᴀ ᴊᴏᴠᴇᴍ *${pushname2}*, TONY ᴘᴏᴅᴇ sᴇʀ ᴀᴊᴜᴅᴀᴅᴏ? ᴅɪɢɪᴛᴇ *${prefix}menu* ʏᴀ ᴋᴀᴋ`)
                  }
			      if (budy.includes(`TONY`)) {
                  reply(`ᴏʟᴀ ᴊᴏᴠᴇᴍ*${pushname2}*, TONY ᴘᴏᴅᴇ sᴇʀ ᴀᴊᴜᴅᴀᴅᴏ? ᴅɪɢɪᴛᴇ *${prefix}menu* ʏᴀ ᴋᴀᴋ`)
                  }
